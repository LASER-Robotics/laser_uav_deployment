...
echo "param set SER_TEL1_BAUD 0" >> ../../miscellaneous/pixhawk/sdcard_config/etc/config.txt
echo "param set SER_TEL2_BAUD 2000000" >> ../../miscellaneous/pixhawk/sdcard_config/etc/config.txt
echo "param set DSHOT_TEL_CFG 0" >> ../../miscellaneous/pixhawk/sdcard_config/etc/config.txt
echo "param set DSHOT_BIDIR_EN 1" >> ../../miscellaneous/pixhawk/sdcard_config/etc/config.txt
echo "param set MAV_0_CONFIG 101" >> ../../miscellaneous/pixhawk/sdcard_config/etc/config.txt
echo "param set MAV_1_CONFIG 103" >> ../../miscellaneous/pixhawk/sdcard_config/etc/config.txt
echo "param set MAV_2_CONFIG 0" >> ../../miscellaneous/pixhawk/sdcard_config/etc/config.txt
